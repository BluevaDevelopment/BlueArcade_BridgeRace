...
import net.blueva.arcade.modules.bridge_race.listener.BridgeRaceDamageListener;
...
public class BridgeRaceModule implements GameModule<Player, Location, World, String, ItemStack, String, Holder, Entity, EventSubscription<?>, Short> {
    ...
    public void registerEvents(CustomEventRegistry<EventSubscription<?>, Short> registry) {
        if (registry instanceof net.blueva.arcade.api.events.hytale.HytaleEventRegistry hytaleRegistry) {
            hytaleRegistry.registerSystem(new BridgeRaceDamageListener(gameManager));
        }
    }
