...
import net.blueva.arcade.modules.bridge_race.BridgeRaceGameManager;
...
public class BridgeRaceDamageListener extends EntityEventSystem<EntityStore, Damage> {

    private final BridgeRaceGameManager gameManager;

    public BridgeRaceDamageListener(BridgeRaceGameManager gameManager) {
        super(Damage.class);
