...
public class BridgeRaceArenaState {
    ...
    public BridgeRaceArenaState(GameContext<Player, Location, World, String, ItemStack, String, Holder, Entity> context) {
    ...
    public void clearPlacedBlocks() {
        // In Hytale, we may need to use the world/block API to set blocks to air
        // For now, track and clear the set - actual block clearing may need Hytale-specific API
        placedBlocks.clear();
    }
}
