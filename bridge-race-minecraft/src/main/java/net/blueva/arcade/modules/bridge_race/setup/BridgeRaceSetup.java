package net.blueva.arcade.modules.bridge_race.setup;
...
public class BridgeRaceSetup implements GameSetupHandler {

    private final ModuleConfigAPI moduleConfig;
    private final CoreConfigAPI coreConfig;

    public BridgeRaceSetup(ModuleConfigAPI moduleConfig, CoreConfigAPI coreConfig) {
