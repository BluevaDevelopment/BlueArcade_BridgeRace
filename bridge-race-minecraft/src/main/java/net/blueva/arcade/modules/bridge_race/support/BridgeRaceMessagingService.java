...
public class BridgeRaceMessagingService {
    ...
    public BridgeRaceMessagingService(ModuleInfo moduleInfo,
                                ModuleConfigAPI moduleConfig,
                                CoreConfigAPI coreConfig,
                                BridgeRaceProgressService progressService) {
    ...
    public void sendSpectatorDescriptions(GameContext<Player, Location, World, Material, ItemStack, Sound, Block, Entity> context) {
        ...
        for (int i = 0; i < spectators.size(); i++) {
            ...
            Map<String, String> placeholders = Map.of("bridge_race_position", String.valueOf(i + 1));
